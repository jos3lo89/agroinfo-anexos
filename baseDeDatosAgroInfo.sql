...
CREATE TABLE `TelefonosUsuario` (
    ...
    UNIQUE INDEX `TelefonosUsuario_usuario_id_key`(`usuario_id`),
...
CREATE TABLE `DireccionesUsuario` (
    ...
    UNIQUE INDEX `DireccionesUsuario_usuario_id_key`(`usuario_id`),
...
CREATE TABLE `MiembrosAsociacion` (
    ...
    UNIQUE INDEX `MiembrosAsociacion_dni_key`(`dni`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Reuniones` (
    ...
    `estado` ENUM('proceso', 'culminado') NOT NULL,
...
CREATE TABLE `ReaccionesPublicaciones` (
    ...
    UNIQUE INDEX `ReaccionesPublicaciones_publicacion_id_usuario_id_key`(`publicacion_id`, `usuario_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
